...
export class MessageInterface extends PlivoResourceInterface {
     ...
     * @param {string} [optionalParams.dltEntityID] This is the DLT entity id passed in the message request.
     * @param {string} [optionalParams.dltTemplateID] This is the DLT template id passed in the message request.
     * @param {string} [optionalParams.dltTemplateCategory] This is the DLT template category passed in the message request.
