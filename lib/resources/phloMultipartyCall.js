...
import { PhloMemberInterface, PhloMember } from './phloMember';
...
export class PhloMultiPartyCall extends PlivoResource {
    constructor(client, data = {}) {
        ...
        this.member.get = async function (memberAddress) {
            let dd = new PhloMultiPartyCallInterface(client, { phloId: item.phloId, nodeId: item.nodeId, memberAddress: memberAddress });
