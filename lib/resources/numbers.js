 ...
 * @param {object} [params.verification_info] - This contains the document associated with the phone number. It will contain: type - “address” or “identity”, id - Identifier of the “address” or “identity” object.
 * @promise {@link PlivoGenericResponse} return PlivoGenericResponse Object if success
 * @fail {Error} return Error
 */
  buy(appId, verification_info) {
 ...
 */
  buy(appId, verification_info) {
    ...
    if (verification_info) {
      params.verification_info = verification_info;
    }
