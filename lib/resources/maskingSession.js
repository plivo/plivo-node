...
export class MaskingSessionInterface extends PlivoResourceInterface {
     ...
     * @param {string} [params.isPinAuthenticationRequired] - The HTTP method for the recording callback request.
     * @param {string} [params.generatePin] - The HTTP method for the recording callback request.
     * @param {string} [params.generatePinLength] - The HTTP method for the recording callback request.
     * @param {string} [params.firstPartyPin] - The HTTP method for the recording callback request.
     * @param {string} [params.secondPartyPin] - The HTTP method for the recording callback request.
     * @param {string} [params.pinPromptPlay] - The HTTP method for the recording callback request.
     * @param {string} [params.pinRetry] - The HTTP method for the recording callback request.
     * @param {string} [params.pinRetryWait] - The HTTP method for the recording callback request.
     * @param {string} [params.incorrectPinPlay] - The HTTP method for the recording callback request.
     * @param {string} [params.unknownCallerPlay] - The HTTP method for the recording callback request.
