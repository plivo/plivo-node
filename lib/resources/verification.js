...
export class AddressVerification extends PlivoResource {
    ...
    delete_address(id) {
        ...
        return (new AddressVerification(this[clientKey], { id: id })).delete(id);
    }

    update_address(dataToUpdate) {

        return (new AddressVerification(this[clientKey], {
...
export class Verification {
    ...
    update_address(dataToUpdate) {
        // If address_id is nor provided in key throw error
        return this.addressVerificationResource.update_address(dataToUpdate);
    }
    ...
    update_identity(dataToUpdate) {
        ...
        // If identity_id is nor provided in key throw error

        return this.identityVerificationResource.update_identity(dataToUpdate);
    }
