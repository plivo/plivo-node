...
export class ListMaskingSessionResponse {
    constructor(params) {
        ...
        this.secondParty= params.secondParty;
        this.virtualNumber= params.virtualNumber;
        this.status= params.status;
        this.initiateCallToFirstParty= params.initiateCallToFirstParty;
        this.sessionUuid= params.sessionUuid;
        this.callbackUrl= params.callbackUrl;
        this.callbackMethod= params.callbackMethod;
        this.createdAt= params.createdTime;
        this.updatedAt= params.modifiedTime;
        this.expiryAt= params.expiryTime;
        this.duration= params.duration;
        this.sessionCreationAmount= params.amount;
        this.callTimeLimit= params.callTimeLimit;
        this.ringTimeout= params.ringTimeout;
        this.firstPartyPlayUrl= params.firstPartyPlayUrl;
        this.secondPartyPlayUrl= params.secondPartyPlayUrl;
        this.record= params.record;
        this.recordFileFormat= params.recordFileFormat;
        this.recordingCallbackUrl= params.recordingCallbackUrl;
        this.recordingCallbackMethod= params.recordingCallbackMethod;
        this.interaction= params.interaction;
        this.totalCallAmount= params.totalCallAmount;
        this.totalCallCount= params.totalCallCount;
        this.totalCallBilledDuration= params.totalCallBilledDuration;
        this.totalSessionAmount= params.totalSessionAmount;
        this.lastInteractionTime= params.lastInteractionTime;    
    }
}
    ...
    listMaskingSession(params) {
        ...
        return new Promise(function (resolve, reject) {
            client('GET', 'Masking/Session/', params).then(function (response) {
                var objects = [];
                Object.defineProperty(objects, 'meta', {
                    value: response.body.response.meta,
                    enumerable: true
                });
                response.body.response.objects.forEach(function (item) {
                    objects.push(new ListMaskingSessionResponse(item, client));
                });
                resolve(objects);
