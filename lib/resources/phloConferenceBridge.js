...
import { PhloConferenceBridgeMember, PhloConferenceBridgeMemberInterface } from './phloConferenceBridgeMember';
...
export class PhloConferenceBridge extends PlivoResource {
    constructor(client, data = {}) {
        ...
        this.member = function (memberAddress) {
            let dd = new PhloConferenceBridgeMember(client, { phloId: item.phloId, nodeId: item.nodeId, memberAddress: memberAddress });
            return dd;
        };

        this.member.get = function (memberAddress) {
            let dd = new PhloConferenceBridgeMemberInterface(client, { phloId: item.phloId, nodeId: item.nodeId, memberAddress: memberAddress });
