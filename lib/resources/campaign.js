 ...
 */
 export class CampaignInterface extends PlivoResource {
     ...
     * @fail {Error} return Error
     */
     listNumber(campaignID, limit=10, offset=0) {
        return super.customexecuteAction(action+campaignID+'/Number/?limit='+limit+'&offset='+offset, 'GET');
    }
