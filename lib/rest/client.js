...
exports.validateSignature = function(method, uri, nonce, auth_token, v3_signature, params={}) {
  return validateSignature(method, uri, nonce, auth_token, v3_signature, params);
};

exports.validateV3Signature = function(uri, nonce, signature, auth_token) {
  return validateV3Signature(uri, nonce, signature, auth_token);
};
