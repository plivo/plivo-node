...
export class Client {
  constructor(authId, authToken, options) {
    ...
    this.phoneNumberCompliance = new PhoneNumberComplianceInterface(client);
    this.phoneNumberComplianceRequirements = new PhoneNumberComplianceRequirementInterface(client);
    this.phoneNumberComplianceLink = new PhoneNumberComplianceLinkInterface(client);
  }
