...
export function Request(config) {
  ...
  return (method, action, params) => {
    ...
    return new Promise((resolve, reject) => {
      ...
      if (method == 'GET' && action == 'phlo/2a38dc9b-b48e-4e4e-b49b-0677c556989c/conference_bridge/f0de5e19-fded-4ede-a04a-258a459688cd/') {
        resolve({
          response: {},
          body:
          {
            apiId: 'a7fc7bde-1aa3-449d-9d8a-3de1da5f8b71',
            nodeId: 'f0de5e19-fded-4ede-a04a-258a459688cd',
