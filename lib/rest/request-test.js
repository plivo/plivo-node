...
export function Request(config) {
  ...
  return (method, action, params) => {
    ...
    return new Promise((resolve, reject) => {
      ...
      // =========== PHLO ============================
      // Get phlo details
      if (method == 'GET' && action == 'phlo/b30083e9-73c9-42a2-acfa-c08e6e66cd83/') {
        resolve({
          response: {},
          body: {
            api_id: '719d8763-f62c-4322-98e2-eed26b85ea8a',
            phlo_id: 'b30083e9-73c9-42a2-acfa-c08e6e66cd83',
            name: 'mpc_test',
      ...
      // Run Phlo
      if (method == 'POST' && action.endsWith('phlo/b30083e9-73c9-42a2-acfa-c08e6e66cd83')) {
        resolve({
          response: {},
          body: {
            phlo_id: 'b30083e9-73c9-42a2-acfa-c08e6e66cd83',
      ...
      if (method == 'GET' && action == 'phlo/b30083e9-73c9-42a2-acfa-c08e6e66cd83/multi_party_call/85169eaf-d8b9-4e3d-9baf-13eb6b231bb0/') {
        resolve({
          response: {},
          body: {
            api_id: 'ea4811e0-b949-489b-8e4a-9dee03fada6e',
            node_id: '85169eaf-d8b9-4e3d-9baf-13eb6b231bb0',
            phlo_id: 'b30083e9-73c9-42a2-acfa-c08e6e66cd83',
      ...
      if (method == 'POST' && action == 'phlo/b30083e9-73c9-42a2-acfa-c08e6e66cd83/multi_party_call/85169eaf-d8b9-4e3d-9baf-13eb6b231bb0') {
        resolve({
          response: {},
      ...
      if (method == 'POST' && action == 'phlo/b30083e9-73c9-42a2-acfa-c08e6e66cd83/multi_party_call/85169eaf-d8b9-4e3d-9baf-13eb6b231bb0/members/919920700964') {
        resolve({
          response: {},
          body: {
      ...
      if (method == 'GET' && action == 'phlo/2a38dc9b-b48e-4e4e-b49b-0677c556989c/conference_bridge/f501faf1-0703-4619-86fa-d537b689e331/') {
        resolve({
          response: {},
          body:
          {
      ...
      if (method == 'POST' && action == 'phlo/2a38dc9b-b48e-4e4e-b49b-0677c556989c/conference_bridge/f501faf1-0703-4619-86fa-d537b689e331/members/919920700964') {
        resolve({
          response: {},
