...
export function Request(config) {
  ...
  return (method, action, params, requestConfig) => {
    ...
    return new Promise((resolve, reject) => {
      ...
      // List identities
      if (method == 'GET' && action == 'Verification/Identity/') {
        resolve({
          response: {},
          body:
          {
      ...
      if (method == 'GET' && action == 'Verification/Identity/27658110766647/') {
        resolve({
          response: {},
          body:
          {
      ...
      if (method == 'POST' && action == 'Verification/Identity/' && params.first_name == '') {
        var response = {
      ...
      //Create Identity Detail By Document Id - Valid input data
      if (method == 'POST' && action == 'Verification/Identity/') {
        resolve({
          response: {},
      ...
      if (method == 'POST' && action == 'Verification/Identity/<id_to_be_updated>/' && params.first_name == '') {
        var response = {
          error: 'first_name field is mandatory.',
          message: 'Could not complete Identity verification.',
          status: 'error'
      ...
      if (method == 'POST' && action == 'Verification/Identity/<id_to_be_updated>/') {
        resolve({
          response: {},
          body: { "apiId": "3269e592-2478-11e9-b01f-0242ac110002", "message": "Your request has been accepted." }
        });
      ...
      if (method == 'DELETE' && action == 'Verification/Identity/18294047791076/') {
        resolve({
          response: {},
          body: undefined
        });
      ...
      // List Addresses
      if (method == 'GET' && action == 'Verification/Address/') {
        resolve({
          response: {},
          body: {
            meta:
      ...
      if (method == 'GET' && action == 'Verification/Address/14632037725844/') {
        resolve({
          response: {},
          body:
          {
      ...
      if (method == 'POST' && action == 'Verification/Address/' && params.first_name == '') {
        var response = {
          error: 'first_name field is mandatory.',
      ...
      if (method == 'POST' && action == 'Verification/Address/23991395742603/ 23991395742603 ') {
        resolve({
          response: {},
          body: { "apiId": "3269e592-2478-11e9-b01f-0242ac110002", "message": "Your request has been accepted." }
        });
      ...
      if (method == 'POST' && action == 'Verification/Address/73529957241107/' && params.first_name == '') {
        var response = {
          error: 'first_name field is mandatory.',
          message: 'Could not complete Address verification.',
          status: 'error'
      ...
      if (method == 'POST' && action == 'Verification/Address/23991395742603/') {
        resolve({
          response: {},
          body: { "apiId": "3269e592-2478-11e9-b01f-0242ac110002", "message": "Your request has been accepted." }
        });
      ...
      if (method == 'DELETE' && action == 'Verification/Address/87928077747492/') {
        resolve({
          response: {},
          body: undefined
        });
