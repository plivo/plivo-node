    ...
    return new Promise((resolve, reject) => {
      ...
      // =========== PHONE NUMBER COMPLIANCE REQUIREMENTS ============================
        ...
        resolve({
          ...
          body: {
            api_id: 'req-api-001',
            compliance_requirement_id: 'cr-123',
            country_iso2: params.country_iso2 || 'US',
            number_type: params.number_type || 'local',
            end_user_type: params.end_user_type || 'business',
      ...
      // =========== PHONE NUMBER COMPLIANCE - CREATE ============================
        ...
        resolve({
          ...
          body: {
            ...
            alias: params.alias || 'test-compliance',
            status: 'draft',
            end_user_type: params.end_user_type || 'business',
            end_user_id: params.end_user_id || 'eu-789',
            country_iso2: params.country_iso2 || 'US',
            number_type: params.number_type || 'local',
            message: 'Compliance application created successfully',
            compliance_requirement_id: params.compliance_requirement_id || 'cr-123',
            documents: [],
            data: null,
          ...
          body: {
            ...
            objects: [
              ...
              },
              {
                ...
                country_iso2: 'DE',
                number_type: 'mobile',
                compliance_requirement_id: 'cr-456',
                documents: [],
                rejection_reason: null,
      ...
      // =========== PHONE NUMBER COMPLIANCE - LINK ============================
        ...
        resolve({
          ...
          body: {
            ...
            message: 'Phone number(s) linked to compliance successfully'
          }
        });
      }
