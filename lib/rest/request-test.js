...
export function Request(config) {
  ...
  return (method, action, params) => {
    ...
    // Accounts
      ...
      if (action == 'Verification/Address/1/' && method == 'GET') {
        resolve({
          response: {},
          body: {
      ...
      if (action == 'Verification/Address/' && method == 'GET') {
        resolve({
          response: {},
          body: {
      ...
      if (action == 'Verification/Address/1/' && method == 'POST') {
        resolve({
          response: {},
          body: {
      ...
      if (action == 'Verification/Address/' && method == 'POST') {
        resolve({
          response: {},
          body: {
      ...
      if (action == 'Verification/Address/1/' && method == 'DELETE') {
        resolve({
          response: {},
          body: {
          }
      ...
      if (action == 'Verification/Identity/1/' && method == 'GET') {
        resolve({
          response: {},
          body: {
            "account": "MAXXXXXXXXXXXXXXXXXX",
      ...
      if (action == 'Verification/Identity/' && method == 'GET') {
        resolve({
          response: {},
          body: {
      ...
      if (action == 'Verification/Identity/1/' && method == 'POST') {
        resolve({
          response: {},
          body: {
            "message": "Your request has been accepted.",
      ...
      if (action == 'Verification/Identity/' && method == 'POST') {
        resolve({
          response: {},
          body: {
            "api_id": "324a7dd8-0db2-11e4-8a4a-123140008edf",
      ...
      if (action == 'Verification/Identity/1/' && method == 'DELETE') {
        resolve({
          response: {},
          body: {
          }
