...
export function Axios(config) {
  ...
  return (method, action, params) => {
    ...
    let apiVoiceUris = ['https://api-messaging.sms.plivodev.com/v1/Account/','https://api-messaging.sms.plivodev.com/v1/Account/','https://api-messaging.sms.plivodev.com/v1/Account/'];
